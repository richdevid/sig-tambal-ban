	    ...
	    <div class="row">
			<div class="col-md-2 user-sidebar">
				...
				<div class="list-group" style="margin-top: 20px;">
					...
					<a href="<?php echo base_url('admin/addlocation') ?>" class="list-group-item <?php echo active_link_method('addlocation', 'admin') ?>">
						<i class="fa fa-plus"></i> Tambah Data
					</a>
					<a href="<?php echo base_url('admin/location') ?>" class="list-group-item <?php echo active_link_method('location', 'admin') ?>">
